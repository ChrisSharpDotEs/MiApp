...
if (!isLogged()) {
    $loginButton = "<a href=\"/login\" class=\"btn btn-primary rounded-0 p-3\">Comenzar</a>";
}
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <main>
        <div class="jumbotron">
            ...
            <section class="text-center py-5 text-light">
                ...
                <p>Esta es mi aplicación de Render</p>
                <?= $loginButton ?? '' ?>
                <div class="py-5">
                    <p>
                        Esta aplicación solo es una muestra sencilla de mis conocimientos en PHP y Docker.
                    </p>
                </div>
            </section>
        </div>
    ...
    <footer class="bg-dark py-3">
        <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-center align-items-center py-3 my-4 border-top">
                ...
                <ul class=" d-none nav col-md-4 justify-content-end list-unstyled d-flex">
                    <li class="ms-3">
